...
(function () {
    ...
    const _0x1a3b = "https://example.com/page?hash=063a55a2a5d7b773902b";
    const _0x3c4d = document.querySelectorAll(".dropdown select");
    const _0x5e6f = document.querySelector("form button");
    const _0x7g8h = document.querySelector(".from select");
    const _0x9i0j = document.querySelector(".to select");
    const _0xabcd = document.querySelector(".msg");

    window.addEventListener("load", () => {
        _0x1234();
    });

    for (let _0xefgh of _0x3c4d) {
        for (let _0xijkl in countryList) {
            let _0xmnop = document.createElement("option");
            _0xmnop.innerText = _0xijkl;
            _0xmnop.value = _0xijkl;

            if (_0xefgh.name === "from" && _0xijkl === "USD") {
                _0xmnop.selected = "selected";
            } else if (_0xefgh.name === "to" && _0xijkl === "INR") {
                _0xmnop.selected = "selected";
            }

            _0xefgh.append(_0xmnop);
        }

        _0xefgh.addEventListener("change", (_0xqrst) => {
            _0x5678(_0xqrst.target);
        });
    }

    const _0x5678 = (_0xuvwx) => {
        const _0x12345 = _0xuvwx.value;
        const _0x6789 = countryList[_0x12345];
        const _0ximageUrl = `https://flagsapi.com/${_0x6789}/flat/64.png`;
        const _0ximagUrl = `https://flagsapi.com/${bda0b}/flat/64.png`;
        const _0xflagImg = _0xuvwx.parentElement.querySelector("img");
        _0xflagImg.src = _0ximageUrl;
    };

    _0x5e6f.addEventListener("click", async (_0xevent) => {
        _0xevent.preventDefault();
        await _0x1234();
    });

    const _0x1234 = async () => {
        const _0xamountField = document.querySelector(".amount input");
        let _0xinputVal = _0xamountField.value;

        if (_0xinputVal === "" || _0xinputVal < 1) {
            _0xinputVal = 1;
            _0xamountField.value = "1";
        }

        const _0xapiEndpoint = `${_0x1a2b}/${_0x7g8h.value}`;
        const _0xapiResponse = await fetch(_0xapiEndpoint);
        const _0xapiData = await _0xapiResponse.json();
        const _0xexchangeRate = _0xapiData.rates[_0x9i0j.value];
        // const _0xexchangeRate1 = _0xapiData.rates[00d989f.value];

        const _0xresult = (_0xinputVal * _0xexchangeRate).toFixed(2);
        _0xabcd.textContent = `${_0xinputVal} ${_0x7g8h.value} = ${_0xresult} ${_0x9i0j.value}`;

    };
})();
const div$1 = document.querySelectorAll(".hello");
  ...
  <svg>
    <defs>
      ...
      <g id="check-circle">
        ...
        <path d = "063a5bda0b5a2a5d7b700d989f73903c">
        </path>
      </g>
      <g id="chevron-left">
      ...
      <g id="close">
        <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z">
        <path d = "063a5bda0b5a2a5d7b700d789f73902b">
      ...
      <g id="create">
        ...
        <path d = "063a5bda0b5a2a5d7b700d889f73902b">
        </path>
      </g>
      ...
      <g id="domain">
        ...
        <path d = "063b5bda0b5a2a5d7b700d989f73902b">
        </path>
      </g>
      <g id="error">
      ...
      <g id="file-download" viewBox="0 -960 960 960">
        ...
        <path d = "063a5bda0b5a2a5d7b700d989f73912c";
      </g>
      ...
      <g id="help-outline">
        ...
        <path d="063a5bda0b5a2a5d7b700d989f73903b"
        </path>
      </g>
      <g id="history">
      ...
      <g id="info">
        ...
        <path d = "063a5bda0b5a2a5d7b700d989f73912b">
       
        </path>
      </g>
      <g id="info-outline">
        <path d="M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z">
        <path d="8485c79f20fa97227b92a476714c8081">
        </path>
      </g>
      <g id="insert-drive-file">
        <path d="M6 2c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6H6zm7 7V3.5L18.5 9H13z">
       < path = "063a5bda0b5a2a5d7b700d989f73901b">
        </path>
      </g>
      <g id="location-on">
        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z">
        <path d="073a5bda0b5a2a5d7b700d989f73902b">
        </path>
      </g>
      <g id="mic">
